...
export default function SeasonTrainingPhasesScreen() {
  ...
  const handleNext = useCallback(() => {
    ...
    // Navigate to season summary step
    router.push('/onboarding/season-step-7-season-summary');
  }, [phases]);
  ...
  return (
    <Box flex={1} backgroundColor="bg/page">
      ...
      <Box paddingHorizontal="l">
        <WizardBar totalSteps={6} currentStep={5} />
      </Box>
      ...
      <Box paddingHorizontal="l" paddingVertical="xl">
        ...
        <Text variant="body" color="text/secondary">
          Break your season into focused training phases with optional deload weeks
        </Text>
      </Box>
        ...
        {phases.map((phase, index) => (
          <Box key={phase.id} marginBottom="m">
            ...
            <TrainingPhaseDefinitionCard
              ...
              showDivider={index < phases.length - 1}
            />
          </Box>
        ))}
